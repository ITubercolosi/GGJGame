...
Shader "Clouds"
{
	Properties
	{
		...
		_BandsTiling("BandsTiling", Float) = 0
		_VoronoiStep("VoronoiStep", Float) = 0
		_PerlinStrength("PerlinStrength", Float) = 0
		_Seed("Seed", Float) = 0
		_WobbleSpeed("WobbleSpeed", Float) = 1
		_FresnelPower("FresnelPower", Float) = 0
		_VoronoiSmoothness("VoronoiSmoothness", Float) = 0
		_FresnelBias("FresnelBias", Float) = 0
		_FresnelScale("FresnelScale", Float) = 0
		_FresnelStep("FresnelStep", Range( 0 , 1)) = 1
		_Color0("Color 0", Color) = (0,0,0,0)
		_SecondaryColour("SecondaryColour", Color) = (0,0,0,0)
		_PrimaryColour("PrimaryColour", Color) = (0,0,0,0)
		_PerlinScale("PerlinScale", Float) = 0
		_TextureSample1("Texture Sample 1", 2D) = "white" {}
		_CloudColour("CloudColour", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float _PerlinScale;
		uniform float _PerlinStrength;
		uniform float _BandsTiling;
		uniform float _Seed;
		uniform float _VoronoiSmoothness;
		...
		float2 voronoihash198( float2 p )
		{
		...
		float voronoi198( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			Input i = s.SurfInput;
			half4 c = 0;
			float temp_output_224_0 = ( _WobbleSpeed / 2.0 );
			float mulTime218 = _Time.y * ( temp_output_224_0 * -0.5 );
			float2 temp_cast_0 = (mulTime218).xx;
			float2 uv_TexCoord217 = i.uv_texcoord + temp_cast_0;
			float simplePerlin2D216 = snoise( uv_TexCoord217*( 2.0 * _PerlinScale ) );
			simplePerlin2D216 = simplePerlin2D216*0.5 + 0.5;
			float mulTime202 = _Time.y * temp_output_224_0;
			float2 temp_cast_1 = (mulTime202).xx;
			float2 uv_TexCoord214 = i.uv_texcoord + temp_cast_1;
			float simplePerlin2D213 = snoise( uv_TexCoord214*_PerlinScale );
			simplePerlin2D213 = simplePerlin2D213*0.5 + 0.5;
			float temp_output_219_0 = ( simplePerlin2D216 * simplePerlin2D213 * _PerlinStrength );
			float time198 = _Seed;
			float2 voronoiSmoothId198 = 0;
			float voronoiSmooth198 = _VoronoiSmoothness;
			float2 uv_TexCoord185 = i.uv_texcoord * _Tiling + _Offset;
			float2 temp_cast_2 = (( temp_output_219_0 + uv_TexCoord185.y )).xx;
			float2 coords198 = temp_cast_2 * _BandsTiling;
			float2 id198 = 0;
			float2 uv198 = 0;
			float voroi198 = voronoi198( coords198, time198, id198, uv198, voronoiSmooth198, voronoiSmoothId198 );
			float temp_output_3_0_g9 = ( _VoronoiStep - ( ( 1.0 - temp_output_219_0 ) * voroi198 ) );
			float temp_output_205_0 = saturate( ( temp_output_3_0_g9 / fwidth( temp_output_3_0_g9 ) ) );
			...
			float4 lerpResult266 = lerp( _SecondaryColour , _PrimaryColour , temp_output_205_0);
			...
			float2 temp_cast_3 = ((0.5 + (dotResult255 - 0.0) * (1.0 - 0.5) / (1.0 - 0.0))).xx;
			c.rgb = _CloudColour.rgb;
			c.a = ( ( 1.0 - temp_output_205_0 ) * _CloudColour.a * ( ( ( _Color0 * saturate( ( ( 1.0 - saturate( ( temp_output_3_0_g10 / fwidth( temp_output_3_0_g10 ) ) ) ) + fresnelNode236 ) ) ) + ( float4( 0,0,0,0 ) + lerpResult266 ) ) * tex2D( _TextureSample1, temp_cast_3 ) ) ).r;
			return c;
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-659.0126,-143.1392;Inherit;False;Property;_SpherizeStrengthY;SpherizeStrengthY;3;0;Create;True;0;0;0;False;0;False;0;6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-488.0759,-49.80127;Inherit;False;Property;_RotationX;RotationX;34;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;34;-318.2237,-45.21201;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-487.0126,29.86118;Inherit;False;Property;_RotationY;RotationY;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-659.2484,-229.7877;Inherit;False;Property;_SpherizeStrengthX;SpherizeStrengthX;4;0;Create;True;0;0;0;False;0;False;0;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-653.7573,-326.189;Inherit;False;Property;_PivotY;PivotY;2;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-652.5214,-404.5406;Inherit;False;Property;_PivotX;PivotX;1;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;528.174,-473.5267;Inherit;False;Property;_RimStep;RimStep;36;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;140;294.4669,59.60903;Inherit;True;Property;_LightGradient;LightGradient;6;0;Create;True;0;0;0;False;0;False;-1;None;b4825519fc2e4ee4a9b13dcb5efb0ae3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;32;401.2059,-274.9829;Inherit;True;Property;_TextureSample0;Texture Sample 0;35;0;Create;True;0;0;0;False;0;False;-1;None;56576aa2ec3e72d4dab77866b32f3e73;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;147;389.8524,270.9185;Inherit;False;Property;_DarkestLight;DarkestLight;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;130;-1083.547,334.7773;Float;False;Property;_DefaultNormal;DefaultNormal;0;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMaxOpNode;139;-281.669,391.7556;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;152;-147.6647,1576.941;Inherit;False;Property;_TileScale;TileScale;8;0;Create;True;0;0;0;False;0;False;0;9.47;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;154;-791.1735,1454.355;Inherit;False;Property;_NoiseTileY;NoiseTileY;9;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;153;-792.1735,1364.355;Inherit;False;Property;_NoiseTileX;NoiseTileX;10;0;Create;True;0;0;0;False;0;False;0;-0.09;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;166;-510.0358,1304.885;Inherit;False;Property;_NoiseScale;NoiseScale;12;0;Create;True;0;0;0;False;0;False;1;1.53;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-833.7939,1138.856;Inherit;False;Property;_MovinNoiseTileX;MovinNoiseTileX;14;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;174;-853.2938,1222.056;Inherit;False;Property;_MovinNoiseTileY;MovinNoiseTileY;13;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;157;-22.43664,1829.934;Inherit;False;Property;_NoiseStep;Noise Step;11;0;Create;True;0;0;0;False;0;False;0;0.63;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;2.582654,933.9493;Inherit;False;Property;_DistortionPower;DistortionPower;16;0;Create;True;0;0;0;False;0;False;0;0.0025;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;220;3123.968,722.0784;Inherit;False;Property;_PerlinStrength;PerlinStrength;20;0;Create;True;0;0;0;False;0;False;0;-2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;199;2540.29,968.6669;Inherit;False;Property;_BandsTiling;BandsTiling;18;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;212;2565.958,865.3749;Inherit;False;Property;_Seed;Seed;21;0;Create;True;0;0;0;False;0;False;0;34.41;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;223;1907.47,360.7118;Inherit;False;Property;_WobbleSpeed;WobbleSpeed;23;0;Create;True;0;0;0;False;0;False;1;0.025;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;188;2001.674,802.7021;Inherit;False;Property;_Offset;Offset;15;0;Create;True;0;0;0;False;0;False;0,0;0,17.76;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;187;2001.674,670.7021;Inherit;False;Property;_Tiling;Tiling;17;0;Create;True;0;0;0;False;0;False;0,0;1,17.46;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;206;3321.764,1269.193;Inherit;False;Property;_VoronoiStep;VoronoiStep;19;0;Create;True;0;0;0;False;0;False;0;0.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;227;3211.645,1083.358;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;229;3147.682,896.4551;Inherit;False;Property;_FadedNoiseStrength;FadedNoiseStrength;22;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;230;2581.271,1111.789;Inherit;False;Property;_VoronoiSmoothness;VoronoiSmoothness;25;0;Create;True;0;0;0;False;0;False;0;0.32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;241;4574.691,-53.92627;Inherit;False;Property;_Color0;Color 0;29;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.4242848,0.2113206,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;226;4451.486,918.8568;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;237;3958.677,408.6914;Inherit;False;Property;_FresnelPower;FresnelPower;24;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;238;3921.677,320.6914;Inherit;False;Property;_FresnelScale;FresnelScale;27;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;239;3932.677,230.6915;Inherit;False;Property;_FresnelBias;FresnelBias;26;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;256;2714.647,488.1725;Inherit;False;Property;_PerlinScale;PerlinScale;32;0;Create;True;0;0;0;False;0;False;0;6.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;4365.531,397.566;Inherit;False;Property;_FresnelStep;FresnelStep;28;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;263;3856.072,1511.217;Inherit;False;Property;_PrimaryColour;PrimaryColour;31;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9137256,0.7137255,0.2039215,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;264;3521.609,1357.878;Inherit;False;Property;_SecondaryColour;SecondaryColour;30;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.937255,0.8196079,0.4392156,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;6155.261,-146.9951;Float;False;True;-1;6;ASEMaterialInspector;0;0;CustomLighting;Clouds;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;0;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;276;5898.45,139.1432;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;275;5714.557,315.8668;Inherit;False;Property;_CloudColour;CloudColour;37;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;268;5285.308,882.3856;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;254;4893.698,1144.999;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;253;4694.267,1009.535;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;255;5057.79,1004.28;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;277;5598.411,191.0132;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;0;9;276;0
WireConnection;0;13;275;0
WireConnection;276;0;277;0
WireConnection;276;1;275;4
WireConnection;276;2;247;0
WireConnection;268;0;255;0
WireConnection;255;0;253;0
WireConnection;255;1;254;0
WireConnection;277;0;205;0
ASEEND*/
//CHKSM=184B47CA63CC9BD2C9D57664689642118293E70A